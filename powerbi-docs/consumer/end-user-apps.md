...
Chcesz utworzyć aplikację? Zobacz [Tworzenie obszarów roboczych ze współpracownikami w usłudze Power BI](end-user-create-apps.md), aby uzyskać więcej informacji.
...
* [Tworzenie i publikowanie aplikacji w usłudze Power BI](end-user-create-apps.md)
