...
* [Wprowadzenie do funkcji pytań i odpowiedzi w usłudze Power BI](end-user-q-and-a.md)
...
1. W prawym górnym rogu ekranu usługi Power BI wybierz ikonę koła zębatego ![ikona koła zębatego](./media/end-user-q-and-a-direct-query/power-bi-cog.png), a następnie pozycję **Ustawienia**.
   
   ![Menu ustawień](./media/end-user-q-and-a-direct-query/powerbi-settings.png)
2. Wybierz pozycję **Zestawy danych**, a następnie zestaw danych do włączenia na potrzeby funkcji pytań i odpowiedzi.
   
   ![Ekran Zestawy danych menu Ustawienia](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-settings.png)
3. Rozwiń węzeł **Pytania i odpowiedzi oraz Cortana**, zaznacz pole wyboru **Włącz funkcję pytań i odpowiedzi dla tego zestawu danych** i wybierz polecenie **Zastosuj**.
    ...
    ![Rozwinięty obszar funkcji Pytania i odpowiedzi](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-directquery.png)
...
[Omówienie funkcji Pytania i odpowiedzi usługi Power BI](end-user-q-and-a.md)  
