---
title: Możliwości usługi Power BI dla użytkowników
description: Z tego przewodnika Szybki start **użytkownicy** dowiedzą się, jak korzystać z usługi Power BI.
services: powerbi
documentationcenter: ''
author: mihart
manager: kvivek
...
### <a name="view-an-app"></a>Wyświetlanie aplikacji
...
1. Wybierz pozycję **Aplikacje** ![Pozycja Aplikacje w lewym okienku nawigacji](./media/end-user-apps/power-bi-apps-bar.png) > **Pobierz aplikacje**. 
     ...
     ![Ikona Pobierz aplikacje](./media/end-user-reading-view/power-bi-get-app.png)
2. W usłudze AppSource w obszarze **Moja organizacja** wykonaj wyszukiwanie, aby zawęzić wyniki i znaleźć odpowiednią aplikację.
     ...
     ![Usługa AppSource, obszar Moja organizacja](./media/end-user-reading-view/power-bi-appsource.png)
...
![pulpit nawigacyjny](media/end-user-reading-view/power-bi-dashboard.png)
...
### <a name="subscribe-to-a-dashboard-or-report"></a>Subskrybowanie pulpitu nawigacyjnego (lub raportu)
...
1. Z górnego menu wybierz pozycję **Subskrybuj** lub wybierz ikonę koperty ![ikona subskrypcji](./media/end-user-subscribe/power-bi-icon-envelope.png).
...
### <a name="view-related-content"></a>Wyświetl zawartość pokrewną
...
![powiązana zawartość](./media/end-user-reading-view/power-bi-view-related-dashboard.png)

### <a name="use-qa-to-ask-questions-using-natural-language"></a>Zadawanie pytań przy użyciu języka naturalnego za pomocą funkcji Pytania i odpowiedzi
...
![Pytania i odpowiedzi](./media/end-user-reading-view/power-bi-qna.png)

### <a name="favorite-a-dashboard"></a>Dodanie pulpitu nawigacyjnego do ulubionych
...
### <a name="open-and-view-a-report-and-report-pages"></a>Otwieranie i wyświetlanie raportów i stron raportów
...
1. Na pulpicie nawigacyjnym wybierz kafelek. W tym przykładzie wybraliśmy kafelek wykresu kolumnowego „Revenue” (Przychód).
    ...
    ![pulpit nawigacyjny z wybranym kafelkiem](./media/end-user-reading-view/power-bi-dashboard2.png)
...
2.  Skojarzony raport zostanie otwarty. Zwróć uwagę, że jesteśmy na stronie „Revenue overview” (Omówienie przychodu). Jest to strona raportu zawierająca wykres kolumnowy, który wybraliśmy na pulpicie nawigacyjnym.
    ...
    ![otwieranie raportu w Widoku do czytania](./media/end-user-reading-view/power-bi-report-opens.png)
...
1. Aby dopasować widok, na pasku menu u góry wybierz pozycję **Widok**.
    ...
    ![menu Widok raportu](media/end-user-reading-view/power-bi-fit.png)

2.  Wybierz jedną z opcji wyświetlania. W tym przykładzie wybraliśmy opcję **Dopasuj do strony**.

    ![opcja Dopasuj do strony w widoku raportu](media/end-user-reading-view/power-bi-report-fit.png)    

### <a name="use-the-report-filters-pane"></a>Używanie okienka filtrów raportu
...
1. Wybierz ikonę **Filtry** w prawym górnym rogu.
   ...
   ![wybieranie ikony filtra](media/end-user-reading-view/filters.png)  
...
2. Wybierz wizualizację, aby ją uaktywnić. Zobaczysz wszystkie filtry, które zostały zastosowane do tej wizualizacji (filtry na poziomie wizualizacji), do całej strony raportu (filtry na poziomie strony) i do całego raportu (filtry na poziomie raportu).
   ...
   ![typy filtrów raportów](media/end-user-reading-view/power-bi-reading-filters.png)

3. Umieść kursor nad filtrem i rozwiń go, wybierając strzałkę w dół.
   
   ![rozszerzanie filtra](media/end-user-reading-view/power-bi-expan-filter.png)

4. Wprowadź zmiany do filtrów i zobacz ich wpływ na elementy wizualne.  
   
     
     ![filtrowanie zaawansowane](media/end-user-reading-view/power-bi-advanced-filter.png)

### <a name="see-how-all-the-visuals-on-a-page-are-interconnected"></a>Sprawdzanie, jak są ze sobą połączone wszystkie wizualizacje na stronie
...
![krzyżowe zaznaczanie](media/end-user-reading-view/pagefilter3b.gif)
> 
### <a name="display-details-on-a-visualization"></a>Wyświetlanie szczegółów w wizualizacji
Umieszczanie kursora nad elementami wizualnymi, aby wyświetlić szczegóły

![umieszczanie kursora na elementach w celu wyświetlania szczegółów](media/end-user-reading-view/amarillachart.png)

### <a name="sort-a-visualization"></a>Sortowanie wizualizacji
...
2. Wybierz wielokropek (...), aby otworzyć opcje sortowania.
    ...
    ![sortowanie wykresu](media/end-user-reading-view/sort.gif) 
...
1. Wybierz pozycję **Widok > Okienko wyboru**, aby otworzyć okienko wyboru. Ustaw przełącznik dla **okienka wyboru** na pozycji Włączone.
    ...
    ![Włączanie okienka wyboru raportu](media/end-user-reading-view/power-bi-selection-pane2.png)

2. Okienko wyboru zostanie otwarte na kanwie raportu. Wybierz wizualizację z listy, aby ją uaktywnić.

    ![okienko wyboru raportu](media/end-user-reading-view/power-bi-selection-pane-new.png)

### <a name="zoom-in-on-individual-visuals"></a>Powiększanie poszczególnych elementów wizualnych
Umieść kursor na elemencie wizualnym i wybierz ikonę **trybu koncentracji uwagi** ![](media/end-user-reading-view/pbi_popouticon.jpg). Po wyświetleniu wizualizacji w trybie koncentracji uwagi rozszerza on ją tak, aby wypełniła całą kanwę raportu, jak pokazano poniżej.
...
### <a name="show-the-data-used-to-create-a-visualization"></a>Wyświetlanie danych użytych do utworzenia wizualizacji
...
2. Aby wyświetlić dane, na których wizualizacja jest oparta, wybierz wielokropek (...), a następnie wybierz pozycję **Pokaż dane**.
   ...
   ![wybieranie opcji Pokaż dane](./media/end-user-show-data/power-bi-show-data2.png)
