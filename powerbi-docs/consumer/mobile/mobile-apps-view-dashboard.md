...
2. [Utwórz własne raporty i pulpity nawigacyjne usługi Power BI](../../service-get-started.md) lub połącz się z istniejącymi [aplikacjami usługi Power BI](../end-user-connect-to-services.md) dla różnych usług, takich jak [Microsoft Dynamics CRM](../../service-connect-to-microsoft-dynamics-crm.md) i [Adobe Analyics](../../service-connect-to-adobe-analytics.md).
