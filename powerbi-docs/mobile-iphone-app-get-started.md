...
![Pulpit nawigacyjny aplikacji mobilnej Power BI na telefon iPhone](media/mobile-iphone-app-get-started/power-bi-mobile-get-started-dash.png)
...
Następnie w aplikacji Power BI dla telefonu iPhone możesz korzystać z pulpitów nawigacyjnych i raportów dostępnych lokalnie oraz w chmurze.
...
1. W telefonie iPhone otwórz aplikację usługi Power BI.
...
3. Otwórz folder Raporty sprzedaży detalicznej lub Raporty sprzedaży, aby zapoznać się ze wskaźnikami KPI i raportami dla urządzeń przenośnych.
   ...
   ![Przykłady usług Reporting Services w aplikacji mobilnej usługi Power BI](media/mobile-iphone-app-get-started/power-bi-iphone-ssrs-samples.png)
...
> [!NOTE]
> Jeśli korzystasz z aplikacji mobilnej Power BI na telefonie iPhone, a Twoja organizacja skonfigurowała funkcję zarządzania aplikacjami mobilnymi w usłudze Microsoft Intune, odświeżanie danych w tle jest wyłączone. Przy następnym otwarciu aplikacji usługa Power BI odświeży dane na podstawie usługi Power BI w Internecie.
> 
> 
...
Poniżej wymieniono inne możliwości korzystania z pulpitów nawigacyjnych i raportów usługi Power BI oraz raportów i wskaźników KPI serwera raportów usługi Power BI lub portalu internetowego usług Reporting Services w aplikacji dla telefonu iPhone.
...
* Wyświetlanie kafelków usługi Power BI w urządzeniu [Apple Watch](mobile-apple-watch.md).
* Ustawianie [alertów danych](mobile-set-data-alerts-in-the-mobile-apps.md) dla swoich danych.
* Udostępnianie [pulpitów nawigacyjnych usługi Power BI](mobile-share-dashboard-from-the-mobile-apps.md).
* [Dodawanie adnotacji i udostępnianie](mobile-annotate-and-share-a-tile-from-the-mobile-apps.md) kafelka, raportu lub wizualizacji.
...
* [Tworzenie obrazów kafelków](mobile-iphone-app-get-started.md) za pomocą aplikacji na telefon iPhone.
