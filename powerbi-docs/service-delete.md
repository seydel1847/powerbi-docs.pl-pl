...
Zestawy danych można usuwać. Jednak usunięcie zestawu danych spowoduje również usunięcie wszystkich raportów i kafelków pulpitów nawigacyjnych, które zawierają dane z tego zestawu danych.
...
* [Usuwanie (usuwanie z Ulubionych) pulpitu nawigacyjnego](service-dashboard-favorite.md#unfavorite-a-dashboard)
