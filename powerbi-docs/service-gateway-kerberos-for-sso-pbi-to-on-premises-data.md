...
Obecnie obsługiwane są poniższe źródła danych, wszystkie w oparciu o [ograniczone delegowanie protokołu Kerberos](https://technet.microsoft.com/library/jj553400.aspx):
