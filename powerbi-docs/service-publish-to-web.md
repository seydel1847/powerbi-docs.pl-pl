...
> 
> [!IMPORTANT]
> Administratorzy usługi Power BI mogą w portalu administracyjnym wyłączyć funkcję Publikuj w sieci Web dla użytkowników. W sekcji **Ustawienia dzierżawcy** ustaw przełącznik funkcji **Publikuj w sieci Web** w pozycji **Wyłączone**. To ustawienie jest stosowane do całej dzierżawy. Aby uzyskać więcej informacji, zobacz [Portal administracyjny usługi Power BI](service-admin-portal.md).
> 
> 
