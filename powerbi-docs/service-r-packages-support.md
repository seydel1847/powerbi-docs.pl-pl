---
title: Dowiedz się, które pakiety języka R są obsługiwane
...
Poniższe sekcje zawierają tabele z alfabetycznymi spisami obsługiwanych i nieobsługiwanych pakietów języka R w usłudze Power BI. Aby uzyskać więcej informacji na temat języka R w usłudze Power BI, zobacz artykuł [Wizualizacje języka R](visuals/service-r-visuals.md).

## <a name="request-support-for-a-new-r-package"></a>Zgłaszanie żądania obsługi nowego pakietu języka R
Listę pakietów języka R obsługiwanych w **usłudze Power BI** można znaleźć w sekcji **Obsługiwane pakiety**. Jeśli chcesz poprosić o wprowadzenie obsługi pakietu języka R, którego nie ma na liście, możesz wysłać wiadomość e-mail do [zespołu ds. języka R w usłudze Power BI](mailto:rinpbifb@microsoft.com).
...
* Ze względu na bezpieczeństwo i prywatność nie obsługujemy pakietów języka R, które dostarczają zapytania klient–serwer przez Internet (na przykład RgoogleMaps) w usłudze. W przypadku takich prób sieć jest blokowana. Lista obsługiwanych i nieobsługiwanych pakietów języka R znajduje się w poniższej sekcji.
...
## <a name="r-packages-that-are-supported-in-power-bi"></a>Pakiety języka R obsługiwane w usłudze Power BI
W poniższej tabeli przedstawiono pakiety **obsługiwane** w usłudze Power BI.
...
|Formuła| 1.2-2| https://cran.r-project.org/web/packages/Formula/index.html |
...
|gridExtra| Macierz| glue|
|gridExtra (>= 2.0.0)| grafika| reshape2|
...
|Macierz| 1.2-10| https://cran.r-project.org/web/packages/Matrix/index.html |
|Macierz| 1.2-10| https://cran.r-project.org/web/packages/Matrix/index.html |
|matrixcalc| coda| NA|
...
|raporty| 0.1.4| https://cran.r-project.org/web/packages/reports/index.html |
...
|rngtools (>= 1.2.3)| cluster| grafika|
...
## <a name="r-scripts-that-are-not-supported-in-power-bi"></a>Skrypty języka R nieobsługiwane w usłudze Power BI
W poniższej tabeli przedstawiono pakiety **nieobsługiwane** w usłudze Power BI.

| Pakiet | Data żądania | Przyczyna |
| --- | --- | --- |
| RgoogleMaps |05.10.2016 |Sieć jest zablokowana |
| mailR |03.10.2016 |Sieć jest zablokowana |
| RevoScaleR |30.08.2016 |Dostarczany tylko z oprogramowaniem Microsoft R Server |

## <a name="next-steps"></a>Następne kroki
Aby uzyskać więcej informacji o języku R w usłudze Power BI, zobacz następujące artykuły:

* [Tworzenie wizualizacji języka R w usłudze Power BI](visuals/service-r-visuals.md)
* [Tworzenie wizualizacji usługi Power BI przy użyciu języka R](desktop-r-visuals.md)
* [Uruchamianie skryptów R w programie Power BI Desktop](desktop-r-scripts.md)
* [Używanie języka R w Edytorze zapytań](desktop-r-in-query-editor.md)
