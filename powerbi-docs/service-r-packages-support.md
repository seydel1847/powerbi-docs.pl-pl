...
Poniższe sekcje zawierają tabele z alfabetycznymi spisami obsługiwanych i nieobsługiwanych pakietów języka R w usłudze Power BI. Aby uzyskać więcej informacji na temat języka R w usłudze Power BI, zobacz artykuł [Wizualizacje języka R](service-r-visuals.md).
...
* [Tworzenie wizualizacji języka R w usłudze Power BI](service-r-visuals.md)
