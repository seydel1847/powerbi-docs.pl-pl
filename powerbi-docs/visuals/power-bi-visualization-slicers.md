...
>[!TIP]
>Elementy fragmentatora listy są domyślnie sortowane rosnąco w porządku alfanumerycznym. Aby odwrócić kolejność sortowania, wybierz wielokropek (**...**) w prawym górnym rogu fragmentatora i wybierz pozycję **Sort by District Manager** (Sortuj według menedżera regionalnego) z listy rozwijanej. 
...
[Tabele w usłudze Power BI](power-bi-visualization-tables.md)
